					...
					inspectedContents ? h("div", { style: { marginTop: "12px", padding: "12px", background: "var(--dsh-bg-secondary, #f9fafb)", borderRadius: "6px", border: "1px solid var(--dsh-border, #e5e7eb)" } },
						h("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" } },
							...
							h("div", { style: { display: "flex", gap: "8px" } },
								...
								h("button", {
									style: { ...btnSecondaryStyle, padding: "2px 8px", fontSize: "11px" },
									onClick: () => setImportSelection({ configs: [], presets: [], sessionIds: [] }),
								}, "取消全选")
							)
						),
						// Configs
						inspectedContents.configs.length > 0 ? h("div", { style: { marginBottom: "12px" } },
							h("div", { style: { fontSize: "11px", fontWeight: 600, color: "var(--dsh-text-secondary, #6b7280)", marginBottom: "4px" } }, "配置文件 (" + inspectedContents.configs.length + ")"),
						...
						inspectedContents.presets.length > 0 ? h("div", { style: { marginBottom: "12px" } },
							h("div", { style: { fontSize: "11px", fontWeight: 600, color: "var(--dsh-text-secondary, #6b7280)", marginBottom: "4px" } }, "Agent 预设 (" + inspectedContents.presets.length + ")"),
							h("div", { style: { maxHeight: "120px", overflowY: "auto" } },
						...
						inspectedContents.sessions.length > 0 ? h("div", { style: { marginBottom: "12px" } },
							h("div", { style: { fontSize: "11px", fontWeight: 600, color: "var(--dsh-text-secondary, #6b7280)", marginBottom: "4px" } }, "会话 (" + inspectedContents.sessions.length + ")"),
							h("div", { style: { maxHeight: "200px", overflowY: "auto" } },
